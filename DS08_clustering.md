...
2. **Supervised Learning** — Classification approach
3. **Unsupervised Learning** — Clustering fundamentals
4. **Clustering Applications** — Market segmentation, social networks
5. **K-Means Algorithm** — Partitioning approach
6. **Advanced Topics** — Optimization and initialization
7. **Density-Based Clustering** — DBSCAN approach
8. **DBSCAN Details** — Formal definitions and implementation
